...
def process_video(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds):
    video_repository.insert_video(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds)
    count_of_frames = cut_video_by_frame(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds)
    save_video_from_frames(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds, count_of_frames)


def cut_video_by_frame(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds):
    video_repository.set_status(file_name_with_format, time_from_in_milliseconds,
                                time_to_in_milliseconds, 'division_by_frame_begun')
    ...
    video_repository.set_status(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds, 'divided')

    return count_of_frames


def save_video_from_frames(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds, count_of_frames):
    video_repository.set_status(file_name_with_format, time_from_in_milliseconds,
                                time_to_in_milliseconds, 'saving_from_frames_begun')
    splitting_by_dots = file_name_with_format.split(".")
    file_name = splitting_by_dots[0]
    ...
    out.release()
    video_repository.set_status(file_name_with_format, time_from_in_milliseconds, time_to_in_milliseconds, 'saved')
